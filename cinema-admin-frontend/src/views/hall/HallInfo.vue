...
<template>
  <div>
    ...
    <el-dialog title="添加影厅" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addHall" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改影厅" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editHallInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="安排座位" :visible.sync="arrangeDialogVisible" :width="arrangeDialogWidth">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveSeat" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
