...
<template>
  <div>
    ...
    <el-card>
      <el-row :gutter="24">
        <el-col :span="24">
          <el-button type="primary" style="font-size: 22px;" @click="addDialogVisible = true">
    ...
    <el-dialog title="添加角色" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addRole" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改角色" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editRole" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="submitRights" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
