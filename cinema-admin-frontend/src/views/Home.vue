  ...
  <el-container class="home-container">
    <el-header>
      <div class="span-container" style="padding: 5px" @click="toWelcome">
        ...
        <div style="margin: 5px; font-size: 28px;font-weight: 600;color: rgba(67,52,166,0.71)">电影院管理系统</div>
      </div>
      <el-button type="danger" @click="logout" icon="iconfont icon-login-out">
         退出</el-button>
    </el-header>
    <el-container>
      <el-aside>
