...
<template>
  <div>
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addUser" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editUserInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
