...
<template>
  <div>
    ...
    <el-dialog title="添加类别" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addMovieCategory" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改类别" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editMovieCategoryInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
