...
<!--      操作按钮-->
    ...
    <el-dialog title="添加电影" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addMovie" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
...
<!--        修改图集-->
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editMovieInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
